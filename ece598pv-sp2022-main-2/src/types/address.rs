...
mod test {
    ...
    #[test]
    fn from_a_test_key() {
        let test_key = hex_literal::hex!("0a0b0c0d0e0f0e0d0a0b0c0d0e0f0e0d0a0b0c0d0e0f0e0d0a0b0c0d0e0f0e0d");
        let addr: Address = Address::from_public_key_bytes(&test_key);
        let correct_addr: Address = hex_literal::hex!("1851a0eae0060a132cf0f64a0ffaea248de6cba0").into();
    ...
    fn from_a_test_key_2() {
        let test_key = hex_literal::hex!("1234");
        let addr: Address = Address::from_public_key_bytes(&test_key);
        let correct_addr: Address = hex_literal::hex!("e39accfbc0ae208096437401b7ceab63cca0622f").into();
        assert_eq!(addr, correct_addr);
